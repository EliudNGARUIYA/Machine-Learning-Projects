...
constexpr int tensorArenaSize = 9 * 1024;
byte tensorArena[tensorArenaSize];

// array to map gesture index to a name
const char* CLASSES[] = {
  "Red", // u8"\U0001F34E", // Red Tomato
  "Orange", // u8"\U0001F34C", // Orange Tomato
  "Green" // u8"\U0001F34A"  // Green Tomato
};
...
void setup() {
  ...
  Serial.println("Eliud NGARUIYA | P52/33754/2019 | CCI-503 Pp3");
  Serial.println("Tomato classification using RGB color sensor");
  Serial.println("--------------------------------------------");
